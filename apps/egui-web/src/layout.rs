...
pub(crate) use geometry::{
    amplitude_cell_index_at, amplitude_grid_dims, amplitude_grid_rect, gate_visible_rect,
    gate_width_cols, layout_metrics, nearest_line, nearest_slot_index, span_resize_handle_edge_at,
    span_resize_handle_rect, LayoutMetrics,
};
