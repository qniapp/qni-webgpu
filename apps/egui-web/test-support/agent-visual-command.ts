...
const DEFAULT_PALETTE_PADDING_Y = 20
const DEFAULT_PALETTE_CIRCUIT_GAP = 48
...
const DEFAULT_LINE_Y =
  DEFAULT_PALETTE_ROW_Y +
  (DEFAULT_GATE_SIZE * 2 + DEFAULT_PALETTE_ROW_GAP) +
  DEFAULT_PALETTE_PADDING_Y +
  DEFAULT_PALETTE_CIRCUIT_GAP +
  DEFAULT_GATE_SIZE / 2
