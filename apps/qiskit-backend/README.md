...
curl -s http://127.0.0.1:4184/run \
  ...
  -d '{"runner":"mock","qubits":4,"columns":[["H",1,1,1],["Amps1","Bloch","Probability","Density"]],"shots":128,"outputs":{"histogram":true,"amplitudes":[{"gate_id":2,"column":1,"span":1,"base_bit":3,"control_mask":0,"control_value":0,"phase_lock_enabled":true}],"bloch":[{"gate_id":3,"column":1,"wire":1}],"probability":[{"gate_id":4,"column":1,"span":1,"base_bit":1}],"densities":[{"gate_id":5,"column":1,"span":1,"base_bit":0}]}}'
```
