/* ─────────────────────────────────────────────────────────────────────
 * qft-dagger-gate.js — <qft-dagger-gate> カスタム要素
 *
...
<div class="body">
  <svg viewBox="0 0 48 48" aria-hidden="true">
    ...
    <g transform="translate(35.347 16.013) scale(0.015360 -0.015360)">
      <path d="M242 0V443H86V532H242V710H342V532H499V443H342V0Z" fill="currentColor"/>
    </g>
  </svg>
</div>
`;

  class QftDaggerGate extends HTMLElement {
  ...
  customElements.define('qft-dagger-gate', QftDaggerGate);
})();
